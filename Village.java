...
public class Village extends Lieu{
	...
	public void choixAction(Personnage p) {
		if(aCarcasse) {
			txt.textAffichage("Les habitants se sont enfuis avec toutes leurs possessions. Il ne reste rien à faire ici");
		}
		else {
			aCarcasse = true;
